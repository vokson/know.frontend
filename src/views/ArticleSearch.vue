    ...
    <div class="row">
      <div class="col">
        <div v-if="isSearchRulesShown" class="row">
          <div class="col">
            <p>Выполняется регистрозависимый поиск по тексту статьи. Для поиска по автору статьи, номеру статьи, заголовку статьи необходимо использовать соответственно фильтры "author:", "uin:", "subject:s"</p>
